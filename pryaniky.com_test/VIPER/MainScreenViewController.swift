...
extension MainScreenViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if type == PostTypes.textOnlyModel.name {
            ...
            guard let textPost = post as? TextOnlyModel else { return UITableViewCell() }
            ...
            guard let imagePost = post as? ImageWithTextModel else { return UITableViewCell() }
            ...
            guard let segmentPost = post as? VariatnsModel else { return UITableViewCell() }
